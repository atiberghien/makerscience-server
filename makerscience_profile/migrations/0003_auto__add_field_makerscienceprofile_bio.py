...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MakerScienceProfile.bio'
        db.add_column(u'makerscience_profile_makerscienceprofile', 'bio',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MakerScienceProfile.bio'
        db.delete_column(u'makerscience_profile_makerscienceprofile', 'bio')
