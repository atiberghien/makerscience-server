...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'MakerScienceProfile.place'
        db.delete_column(u'makerscience_profile_makerscienceprofile', 'place_id')

        # Adding unique constraint on 'MakerScienceProfile', fields ['slug']
        db.create_unique(u'makerscience_profile_makerscienceprofile', ['slug'])
    ...
    models = {
        ...
        u'makerscience_profile.makerscienceprofile': {
            ...
            'place': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['scout.Place']", 'null': 'True', 'blank': 'True'}),
