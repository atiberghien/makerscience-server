...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MakerScienceProfile.bio'
        db.alter_column(u'makerscience_profile_makerscienceprofile', 'bio', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MakerScienceProfile.bio'
        raise RuntimeError("Cannot reverse this migration. 'MakerScienceProfile.bio' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'MakerScienceProfile.bio'
        db.alter_column(u'makerscience_profile_makerscienceprofile', 'bio', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'makerscience_profile.makerscienceprofile': {
            ...
            'authorized_contact': ('django.db.models.fields.CharField', [], {'default': "'ALL'", 'max_length': '8'}),
            ...
            'notif_subcription_freq': ('django.db.models.fields.CharField', [], {'default': "'WEEKLY'", 'max_length': '6'}),
