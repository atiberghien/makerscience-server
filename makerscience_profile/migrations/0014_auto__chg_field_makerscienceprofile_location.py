...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MakerScienceProfile.location'
        db.alter_column(u'makerscience_profile_makerscienceprofile', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scout.Place'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'MakerScienceProfile.location'
        db.alter_column(u'makerscience_profile_makerscienceprofile', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scout.Place'], null=True))
