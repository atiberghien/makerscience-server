...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'makerscience_profile_makerscienceprofile', 'authorized_contact',
                      self.gf('django.db.models.fields.CharField')(default='NONE', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MakerScienceProfile.authorized_contact'
        db.delete_column(u'makerscience_profile_makerscienceprofile', 'authorized_contact')
    ...
    models = {
        ...
        u'makerscience_profile.makerscienceprofile': {
            ...
            'authorized_contact': ('django.db.models.fields.CharField', [], {'default': "'NONE'", 'max_length': '8'}),
            ...
            'notif_subcription_freq': ('django.db.models.fields.CharField', [], {'default': "'NONE'", 'max_length': '6'}),
