...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MakerScienceProfileTaggedItem'
        db.create_table(u'makerscience_profile_makerscienceprofiletaggeditem', (
        ...
        db.send_create_signal(u'makerscience_profile', ['MakerScienceProfileTaggedItem'])


    def backwards(self, orm):
        # Deleting model 'MakerScienceProfileTaggedItem'
        db.delete_table(u'makerscience_profile_makerscienceprofiletaggeditem')
