...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'makerscience_profile_makerscienceprofile', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='slug', unique=True, max_length=50, populate_from=None, unique_with=()),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MakerScienceProfile.slug'
        db.delete_column(u'makerscience_profile_makerscienceprofile', 'slug')
