...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MakerScienceProfile.modified'
        db.add_column(u'makerscience_profile_makerscienceprofile', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 11, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MakerScienceProfile.modified'
        db.delete_column(u'makerscience_profile_makerscienceprofile', 'modified')
