...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MakerScienceResource'
        db.create_table(u'makerscience_catalog_makerscienceresource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('modified', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'makerscience_catalog', ['MakerScienceResource'])


    def backwards(self, orm):
        # Deleting model 'MakerScienceResource'
        db.delete_table(u'makerscience_catalog_makerscienceresource')
