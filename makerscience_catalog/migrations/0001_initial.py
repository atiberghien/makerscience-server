...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MakerScienceProject'
        db.create_table(u'makerscience_catalog_makerscienceproject', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
        ))
        db.send_create_signal(u'makerscience_catalog', ['MakerScienceProject'])


    def backwards(self, orm):
        # Deleting model 'MakerScienceProject'
        db.delete_table(u'makerscience_catalog_makerscienceproject')
