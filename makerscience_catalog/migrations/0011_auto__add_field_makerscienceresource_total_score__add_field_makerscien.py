...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MakerScienceResource.total_score'
        db.add_column(u'makerscience_catalog_makerscienceresource', 'total_score',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'MakerScienceProject.total_score'
        db.add_column(u'makerscience_catalog_makerscienceproject', 'total_score',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MakerScienceResource.total_score'
        db.delete_column(u'makerscience_catalog_makerscienceresource', 'total_score')

        # Deleting field 'MakerScienceProject.total_score'
        db.delete_column(u'makerscience_catalog_makerscienceproject', 'total_score')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'begin_date': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'end_date': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['scout.Place']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'progress': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.ProjectProgress']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': "['title']", 'max_length': '50', 'populate_from': "'title'"}),
