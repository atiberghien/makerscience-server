...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MakerScienceResource.cost'
        db.alter_column(u'makerscience_catalog_makerscienceresource', 'cost', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'MakerScienceResource.cost'
        db.alter_column(u'makerscience_catalog_makerscienceresource', 'cost', self.gf('django.db.models.fields.PositiveIntegerField')())
