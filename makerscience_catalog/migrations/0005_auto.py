...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field linked_resources on 'MakerScienceProject'
        m2m_table_name = db.shorten_name(u'makerscience_catalog_makerscienceproject_linked_resources')
        ...
        db.create_unique(m2m_table_name, ['makerscienceproject_id', 'makerscienceresource_id'])


    def backwards(self, orm):
        # Removing M2M table for field linked_resources on 'MakerScienceProject'
        db.delete_table(db.shorten_name(u'makerscience_catalog_makerscienceproject_linked_resources'))
    ...
    models = {
        u'makerscience_catalog.makerscienceproject': {
            ...
            'linked_resources': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['makerscience_catalog.MakerScienceResource']", 'null': 'True', 'symmetrical': 'False'}),
